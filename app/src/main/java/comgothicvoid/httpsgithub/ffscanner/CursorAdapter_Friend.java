 ...
 */
public class CursorAdapter_Friend extends CursorAdapter {
    private LayoutInflater mInflater;
    private Context mContext;
    public CursorAdapter_Friend(Context context, Cursor c) {
        super(context, c);
        mContext = context;
    ...
    public void bindView(final View view, final Context context, final Cursor cursor) {
        ...
        del.setOnClickListener(new  View.OnClickListener()
        {
            public void onClick(View v){
                ...
                final Dialog_DeleteFriend.Builder builder = new Dialog_DeleteFriend.Builder(context);
                builder.setNumb(id);
                builder.setPositiveButton(new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        db.delete("friends","num=?",new String[]{id});
    ...
    public View newView(Context arg0, Cursor arg1, ViewGroup arg2) {
        return mInflater.inflate(R.layout.friends_list_item, arg2, false);
    }
}
